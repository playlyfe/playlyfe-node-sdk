...
Playlyfe = (function() {
  function Playlyfe(options) {
    ...
    if ((base1 = this.options).load == null) {
      base1.load = (function(_this) {
        return function() {
  ...
  Playlyfe.prototype.api = function(method, url, query, body, raw) {
    if (query == null) {
      query = {};
    }
    if (body == null) {
  ...
  Playlyfe.prototype.get = function(url, query, raw) {
    return this.api('GET', url, query, {}, raw);
  };

  Playlyfe.prototype.post = function(url, query, body) {
    return this.api('POST', url, query, body);
  };

  Playlyfe.prototype.patch = function(url, query, body) {
    return this.api('PATCH', url, query, body);
  };

  Playlyfe.prototype.put = function(url, query, body) {
    return this.api('PUT', url, query, body);
  };

  Playlyfe.prototype["delete"] = function(url, query) {
    return this.api('DELETE', url, query);
  };
